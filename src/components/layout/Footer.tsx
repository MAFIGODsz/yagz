  ...
  return (
    <footer className="relative overflow-hidden border-t border-hairline bg-offwhite">
      <div className="container-px pb-24 pt-16 lg:py-16">
        ...
        <div className="flex flex-col items-center justify-between gap-3 text-xs text-ink-muted sm:flex-row sm:items-start">
          {/* Esquerda: copyright + CNPJ abaixo (desktop) */}
          <div className="flex flex-col items-center gap-0.5 sm:items-start">
            <p>© {year} {PROFILE.name}. Todos os direitos reservados.</p>
            <p className="hidden opacity-60 sm:block">CNPJ: {CONTACT.cnpj}</p>
          </div>
          ...
          {/* Direita: frase + CNPJ abaixo (mobile) */}
          <div className="flex flex-col items-center gap-0.5 sm:items-end">
            ...
            <p className="opacity-60 sm:hidden">CNPJ: {CONTACT.cnpj}</p>
          </div>
        </div>
      </div>
    </footer>
